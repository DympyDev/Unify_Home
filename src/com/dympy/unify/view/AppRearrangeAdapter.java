 ...
 */
public class AppRearrangeAdapter extends StableArrayAdapter {
    private Context context;
    private int layoutResourceId;
    private ArrayList<ItemApp> data;

    public AppRearrangeAdapter(Context context, int layoutResourceId, ArrayList<ItemApp> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ItemApp tempItem = data.get(position);
